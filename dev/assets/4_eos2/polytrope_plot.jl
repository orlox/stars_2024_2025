...
text!(ax, 3,0.95, text=L"n=1.5", color="teal", fontsize=35)
text!(ax, 3,0.85, text=L"z_n = 3.654,\; (-z^2 \mathrm{d}w/\mathrm{d}z)_{z=z_n}=2.174", color="teal", fontsize=35)
text!(ax, 3,0.7, text=L"n=3", color="red2", fontsize=35)
text!(ax, 3,0.6, text=L"z_n = 6.897,\; (-z^2 \mathrm{d}w/\mathrm{d}z)_{z=z_n}=2.018", color="red2", fontsize=35)
